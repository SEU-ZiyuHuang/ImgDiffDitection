// 历史 ONNX Runtime 版 SuperPoint + LightGlue 定位器。
// 模型期望输入名为 images、输出名为 keypoints/matches/mscores。它当前被 #if 0 禁用，
// 仅作为 ONNX 改造参考；正式接入前需抽出公共声明、校验节点名和张量形状，并使其
// 与 yidong_main.cpp 的 ModelPipeline 接口兼容。
#if 0
