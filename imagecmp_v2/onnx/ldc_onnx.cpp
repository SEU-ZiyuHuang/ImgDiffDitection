// 历史 ONNX Runtime 版 LDC 边缘检测器。
// 输入为 [1,3,H,W] RGB float，多个输出尺度经 sigmoid 和平均融合为轮廓图。
// 当前被 #if 0 禁用；切换 ONNX Runtime 时应与现有 ldc.h 统一为同一公开类定义。
#if 0
